...
devDependencies:
  ...
  vuepress:
    specifier: 2.0.0-beta.60
    version: 2.0.0-beta.60(@vuepress/client@2.0.0-beta.60)(vue@3.2.45)
...
packages:
  ...
  /@vuepress/markdown@2.0.0-beta.60:
    ...
    dependencies:
      ...
      '@vuepress/utils': 2.0.0-beta.60
      markdown-it: 13.0.1
      markdown-it-anchor: 8.6.6(@types/markdown-it@12.2.3)(markdown-it@13.0.1)
  ...
  /@vuepress/plugin-search@2.0.0-beta.60:
    resolution: {integrity: sha512-9ENqni4H35/L6vab5DpQfy92DcKPL+36xxoOj1EqZfjU/IlIOFKz4TK8JwhaX+reswokF8NriPFcWol4xIa5IA==}
    dependencies:
      '@vuepress/client': 2.0.0-beta.60
      '@vuepress/core': 2.0.0-beta.60
      '@vuepress/shared': 2.0.0-beta.60
  ...
  /@vueuse/core@9.10.0(vue@3.2.45):
    ...
    dependencies:
      ...
      '@vueuse/shared': 9.10.0(vue@3.2.45)
  ...
  /vuepress-vite@2.0.0-beta.60(@vuepress/client@2.0.0-beta.60)(vue@3.2.45):
  ...
  /vuepress@2.0.0-beta.60(@vuepress/client@2.0.0-beta.60)(vue@3.2.45):
