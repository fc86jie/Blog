<template><div><nav class="table-of-contents"><ul><li><a href="#选择排序">选择排序</a></li><li><a href="#冒泡排序">冒泡排序</a></li><li><a href="#插入排序">插入排序</a></li><li><a href="#高频率查询数组从-l-r-位置的累加和">高频率查询数组从 L~R 位置的累加和</a></li><li><a href="#math-random-算法应用">Math.random()算法应用</a></li><li><a href="#二分法">二分法</a></li><li><a href="#单链表">单链表</a></li></ul></nav>
