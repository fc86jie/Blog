<template><div><nav class="table-of-contents"><ul><li><a href="#删除文件及历史记">删除文件及历史记</a></li></ul></nav>
<h3 id="删除文件及历史记" tabindex="-1"><a class="header-anchor" href="#删除文件及历史记" aria-hidden="true">#</a> 删除文件及历史记</h3>
<p><code v-pre>filter-branch</code>：修改历史提交记录，把不需要的文件永久从历史记录中删除</p>
