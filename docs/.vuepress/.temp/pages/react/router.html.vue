...
<h3 id="route-路由" tabindex="-1"><a class="header-anchor" href="#route-路由" aria-hidden="true">#</a> Route 路由</h3>
  ...
  <span class="token keyword">return</span> <span class="token punctuation">(</span>
    <span class="token operator">&lt;</span><span class="token operator">></span>
      <span class="token operator">&lt;</span>Routes<span class="token operator">></span>
        <span class="token operator">&lt;</span>Route path<span class="token operator">=</span><span class="token punctuation">{</span><span class="token punctuation">[</span><span class="token string">'/'</span><span class="token punctuation">,</span> <span class="token string">'/home'</span><span class="token punctuation">]</span><span class="token punctuation">}</span> exact element<span class="token operator">=</span><span class="token punctuation">{</span><span class="token operator">&lt;</span>Home <span class="token operator">/</span><span class="token operator">></span><span class="token punctuation">}</span> <span class="token operator">/</span><span class="token operator">></span>
        <span class="token operator">&lt;</span>Route path<span class="token operator">=</span><span class="token string">"/about"</span> exact strict element<span class="token operator">=</span><span class="token punctuation">{</span><span class="token operator">&lt;</span>About <span class="token operator">/</span><span class="token operator">></span><span class="token punctuation">}</span> <span class="token operator">/</span><span class="token operator">></span>
...
<li>路由匹配规则
<ol>
<li>默认规则，当 url 以当前 path 为开始时则匹配</li>
<li>exact 精确匹配，url === path || url === path/ 则匹配</li>
<li>strict 严格匹配， url===path，严格匹配必须基于 exact</li>
<li>多路径匹配 []</li>
<li>Routes 最佳匹配</li>
</ol>
</li>
</ul>
<h3 id="link-和-navlink" tabindex="-1"><a class="header-anchor" href="#link-和-navlink" aria-hidden="true">#</a> Link 和 NavLink</h3>
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code><span class="token keyword">function</span> <span class="token function">App</span><span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
  <span class="token keyword">return</span> <span class="token punctuation">(</span>
    <span class="token operator">&lt;</span><span class="token operator">></span>
...
<li>Link：to 要跳转的 url</li>
<li>NavLink：
<ol>
<li>to 要跳转的 url</li>
<li>activeClassName 当前被选中后的 class，默认 active</li>
<li>activeStyle 当前被选中后的 style</li>
<li>默认使用的是模糊匹配，exact 精确匹配</li>
<li>isActive： fun 判断当前是否应该选中</li>
</ol>
</li>
</ul>
</div></template>
